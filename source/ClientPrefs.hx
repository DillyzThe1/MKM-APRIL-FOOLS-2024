...
class ClientPrefs
{
	...
	public static var pauseMusic:String = 'Betwixt The Chaos';
	...
	public static var keyUnlockerStuffs:Map<String, Bool> = ['' => true, 'tutorial-start' => true];
	...
	public static function loadPrefs()
	{
		...
		if (FlxG.save.data.fnf_mkm_keyUnlockerStuffs != null)
		{
			var savedMap:Map<String, Dynamic> = FlxG.save.data.fnf_mkm_keyUnlockerStuffs;
			for (name => value in savedMap)
			{
