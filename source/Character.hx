...
class Character extends FlxSprite
{
			...
			default:
				...
				try
				{
					switch (spriteType)
					{
						...
						case "texture1":
							frames = AtlasFrameMaker.construct1(json.image);
					}
				}
				catch (e:Exception)
				{
					...
					if (PlayState.instance != null)
						PlayState.instance.addTextToDebug(e + "", FlxColor.RED);
				}
	...
	public function playAnim(AnimName:String, Force:Bool = false, Reversed:Bool = false, Frame:Int = 0):Void
	{
		...
		{
			var splitThing:Array<String> = AnimName.split('-');
