// OVERRIDE FOR vlc.MP4Handler IN hxCodec
// ALLOWS YOU TO DISABLE PAUSING
package vlc;
...
class MP4Handler extends VlcBitmap
{
	...
	public function new(canSkip:Bool = true, width:Float = 320, height:Float = 240, autoScale:Bool = true)
	{
